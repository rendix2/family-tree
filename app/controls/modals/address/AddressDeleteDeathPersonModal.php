...
class AddressDeleteDeathPersonModal extends Control
{
    ...
    public function addressDeleteDeathPersonFormYesOnClick(SubmitButton $submitButton, ArrayHash $values)
    {
        ...
        $this->personManager->update()->updateByPrimaryKey($values->personId, ['deathAddressId' => null]);

        $deathPersons = $this->personManager->select()->getSettingsCachedManager()->getByDeathAddressId($values->personId);
